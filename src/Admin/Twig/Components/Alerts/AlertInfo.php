...
/**
 * Alerta informativa reutilizable para notificaciones del admin.
 *
 * Uso desde Twig:
 *
 * <twig:component_alert_info
 *     message="La operación se procesará en segundo plano."
 *     :autoHideDelay="5000"
 *     :dismissible="true"
 * />
 *
...
#[AsTwigComponent(
    ...
    template: '@admin/components/alerts/alert_info_component.html.twig'
)]
final class AlertInfo
{
    ...
    {
        if ('' === $this->id) {
            $this->id = 'alert-info-' . bin2hex(random_bytes(4));
        }
